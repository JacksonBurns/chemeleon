...
python ${SCRIPT_DIR}/04_calc_embeddings.py --endpoint "${CONFIG_DIR}/endpoints.yaml" --n_jobs $N_JOBS --model-name chemeleon
python ${SCRIPT_DIR}/04_calc_embeddings.py --endpoint "${CONFIG_DIR}/endpoints.yaml" --n_jobs $N_JOBS --model-name chemprop
python ${SCRIPT_DIR}/04_calc_embeddings.py --endpoint "${CONFIG_DIR}/endpoints.yaml" --n_jobs $N_JOBS --model-name chemeleon_no_weights
