...
"""
    ...
    for random_seed in (42, 117, 709, 1701, 9001):
        ...
        for benchmark_name in (
            ...
            max_features = "log2" # sometimes better accuracy, sometimes worse but faster training
            ...
            pipe = Pipeline(
                [
                    ...
                    ("mol2_fp_physchem", FeatureUnion([
                        ...
                        ("physchem", MolecularDescriptorTransformer(
                            desc_list=[
                                desc for desc in MolecularDescriptorTransformer().available_descriptors
                                if desc != "Ipc" # Ipc frequently has overflow issues for larger molecules
                            ],
                            n_jobs=-1,
                        )),
                     ])),
